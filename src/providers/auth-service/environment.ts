...
export const environment = {
    ...
    authentication: {
        ...
        loadUserInfo: false,
        federationSigningUrl: 'http://localhost:8080/uaa/oauth/authorize?response_type=id_token&scope=openid&client_id=sisuite-blueprint'
            + '&redirect_uri=http://localhost:8100/assets/callback.html',
